    ...
    <div>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <!--BEGIN CONTENT-->
                <div class="page-content" ng-app="myapp" ng-controller="usercontroller" ng-init="displayData()">
                    <div id="tab-general">
                        <div class="row mbl">
                            <div class="col-lg-12">
                                <div class="col-md-12">
                                                ...
                                                <div class="form-body pal">
                                                    <div class="form-group">
                                                        <label for="inputName" class="col-md-3 control-label">
                                                            Ingresa tu rol</label>
                                                        <div class="col-md-9">
                                                            <div class="input-icon right">
                                                                <i class="fa fa-user"></i>
                                                                
                                                                <input  type="text" placeholder="Ingresa el nuevo rol a crear" class="form-control"  ng-model="nombreRol" name="nombreRol"/></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-actions pal">
                                                    <div class="form-group mbn">
                                                        <div class="col-md-offset-3 col-md-6">
                                                            ...
                                                            <button type="submit" class="btn btn-primary" ng-click="insertData()" name="btnInsert"
value="{{btnName}}">
                                         ...
                                         <div class="panel panel-yellow">
                            <div class="panel-heading">Lista de los roles</div>
